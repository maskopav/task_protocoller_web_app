  ...
  export const createProject = async (req, res) => {
    const { name, description, countries, contact_persons, contact_emails, created_by } = req.body;
    ...
    try {
        const result = await executeQuery(
            ...
            [name, description, countries, contact_persons, contact_emails, created_by, created_by]
        );
