...
(function () {
  const TRANSLATIONS = {
    en: {
      ...
      noSlotIntro: "Let us know when you're available and we'll be in touch to schedule a time.",
      preferredTimesLabel: "When would work for you?",
      noSlotSubmitButton: "Send",
      sendingButton: "Sending…",
      noSlotFailed: "Failed to send",
      noSlotConfirmedHeading: "Thanks — we'll be in touch",
      noSlotConfirmedNotice: "We've emailed you a link back to this page so you can check for new openings, and we'll contact you to schedule a suitable time.",
    ...
    cs: {
      ...
      noSlotIntro: "Napište nám, kdy máte čas, a my se vám ozveme s vhodným termínem.",
      preferredTimesLabel: "Kdy by se vám to hodilo?",
      noSlotSubmitButton: "Odeslat",
      sendingButton: "Odesílám…",
      noSlotFailed: "Odeslání se nezdařilo",
      noSlotConfirmedHeading: "Děkujeme — ozveme se vám",
      noSlotConfirmedNotice: "Poslali jsme vám e-mailem odkaz zpět na tuto stránku, abyste mohli sledovat nové termíny, a my se vám ozveme s vhodným časem.",
    ...
    de: {
      ...
      noSlotIntro: "Teilen Sie uns mit, wann Sie Zeit haben — wir melden uns bei Ihnen, um einen Termin zu vereinbaren.",
      preferredTimesLabel: "Wann würde es Ihnen passen?",
      noSlotSubmitButton: "Senden",
      sendingButton: "Wird gesendet…",
      noSlotFailed: "Senden fehlgeschlagen",
      noSlotConfirmedHeading: "Danke — wir melden uns",
      noSlotConfirmedNotice: "Wir haben Ihnen einen Link zu dieser Seite per E-Mail geschickt, damit Sie neue Termine sehen können, und werden Sie kontaktieren, um einen passenden Termin zu vereinbaren.",
