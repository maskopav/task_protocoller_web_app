...
const TRANSLATIONS = {
  en: {
    ...
    noSlotBody: (r) => `We've noted that none of the currently offered times work for you. We'll be in touch soon to find a suitable time.`,
    noSlotLinkButton: "Check available times",
  },
  cs: {
    confirmationSubject: (r) => `Termín návštěvy potvrzen — ${r}`,
    confirmationHeading: "Vaše návštěva byla potvrzena",
    rescheduledSubject: (r) => `Termín návštěvy přeložen — ${r}`,
    rescheduledHeading: "Vaše návštěva byla přeložena",
    cancelledSubject: (r) => `Termín návštěvy zrušen — ${r}`,
    ...
    noSlotBody: (r) => `Zaznamenali jsme, že vám nevyhovuje žádný z aktuálně nabízených termínů. Brzy se vám ozveme, abychom našli vhodný termín.`,
  ...
  de: {
    ...
    noSlotBody: (r) => `Wir haben notiert, dass keiner der aktuell angebotenen Termine für Sie passt. Wir melden uns bald, um einen passenden Termin zu finden.`,
